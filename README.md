...
As mentioned above, the Dosaku agent uses OpenAI's GPT Service to run numerous sub-agents to do its tasks, including 
chatting with the user. If desired, Dosaku can also run Executor modules:
