...
trust the code source (likely GPT or an equivalent model), understand how the code was generated, whether it is safe to 
run and, generally, how it is being used on your behalf. 
